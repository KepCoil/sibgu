...
(function($) {
	$.fn.switchItems = function() {
		return this.addClass("switch-items-daddy").append("<div class='tmb-wrap'><div class='tmb-wrap-table'>").append("<div class='image-wrap'>").each(function() {
			...
			this_wrapper.find(".bra-plugin-item").appendTo(this_wrapper.find(".image-wrap")).each(function() {
			...
			var this_img = $(realTarget).parent(".tmb-wrap-table").closest(".switch-items-daddy").find(".bra-plugin-item");
			var all_thmbs = $(realTarget).parent(".tmb-wrap-table").find(".switcher-col");
			this_img.hide().eq($(realTarget).index()).css("display", "block");
			all_thmbs.removeClass("active");
			$(realTarget).addClass("active");
		}).find(".switcher-col").hover(function() {
			var this_img = $(this).parent(".tmb-wrap-table").closest(".switch-items-daddy").find(".bra-plugin-item");
