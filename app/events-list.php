			...
			<div class="wrap-events-list">
				...
				<div class="row">
							...
							<div class="table-responsive">
								<table class="table table-striped table-events">
									...
									<tbody>
										<tr>
											<td>
												<time>24.11.2017 <span>11:00</span></time>
												<time>24.11.2017 <span>16:00</span></time>
											</td>
										...
										<tr>
											<td>
												<time>24.11.2017 <span>11:00</span></time>
												<time>28.11.2017 <span>18:00</span></time>
											</td>
					...
					<div class="col-lg-5 col-md-6">
						<div class="wrap-events-category">
							<ul>
								<li class="active">
									<a href="#">Все мероприятия</a>
								</li>
								<li>
									<a href="#">Официальные мероприятия</a>
								</li>
								<li>
									<a href="#">Культурные мероприятия</a>
								</li>
								<li>
									<a href="#">Конференции</a>
								</li>
								<li>
									<a href="#">Иные мероприятия</a>
								</li>
							</ul>
						</div>
					</div>
